...
import { Property, InvestmentCategory } from "@/types";
    ...
    >
      <div className="w-full max-w-md rounded-xl bg-card border border-border p-4 sm:p-6 shadow-xl max-h-[95vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Property */}
          <div>
            <label htmlFor="inv-property" className="block text-sm font-medium text-foreground">
              Property *
            </label>
            <select
              id="inv-property"
          ...
          {/* Category */}
          <div>
            <label htmlFor="inv-category" className="block text-sm font-medium text-foreground">
              Category *
            </label>
            {fetchingCats ? (
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full rounded-md border border-border bg-background px-3 py-2 text-sm text-foreground placeholder-muted-foreground focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
              placeholder="e.g., New sofa set for living room"
